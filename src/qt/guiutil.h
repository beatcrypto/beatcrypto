...
/** Utility functions used by the BeatCrypto Qt UI.
 */
namespace GUIUtil
{
...
// Render BeatCrypto addresses in monospace font
...
// Parse "beatcrypto:" URI into recipient object, return true on successful parsing
