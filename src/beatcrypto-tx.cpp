...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BeatCrypto Core beatcrypto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  beatcrypto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beatcrypto transaction") + "\n" +
                               "  beatcrypto-tx [options] -create [commands]   " + _("Create hex-encoded beatcrypto transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded beatcrypto transaction
