...
/** 
    ...
    ****Note - for BeatCrypto we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of beatcrypto coming in to a transaction
