                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BeatCrypto from zBeatCrypto"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBeatCrypto"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBeatCrypto));
