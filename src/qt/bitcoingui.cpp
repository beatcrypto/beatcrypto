                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BeatCrypto Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BeatCrypto address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beatcrypto: URIs)"));
    ...
    */
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BeatCrypto Core"), this);
    aboutAction->setStatusTip(tr("Show information about BeatCrypto Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BeatCrypto"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BeatCrypto addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BeatCrypto addresses"));
    ...
    openAction->setStatusTip(tr("Open a BeatCrypto: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BeatCrypto Core help message to get a list with possible BeatCrypto command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BeatCrypto Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BeatCrypto network", "", count));
}
...
{
    QString strTitle = tr("BeatCrypto Core"); // default title
...
/** Creates context menu, its actions, and beatcryptos up all the relevant signals for mouse events. */
