...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BeatCrypto server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BeatCrypto server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BeatCrypto features */
        {"beatcrypto", "masternode", &masternode, true, true, false},
        {"beatcrypto", "listmasternodes", &listmasternodes, true, true, false},
        {"beatcrypto", "getmasternodecount", &getmasternodecount, true, true, false},
        {"beatcrypto", "masternodeconnect", &masternodeconnect, true, true, false},
        {"beatcrypto", "masternodecurrent", &masternodecurrent, true, true, false},
        {"beatcrypto", "masternodedebug", &masternodedebug, true, true, false},
        {"beatcrypto", "startmasternode", &startmasternode, true, true, false},
        {"beatcrypto", "createmasternodekey", &createmasternodekey, true, true, false},
        {"beatcrypto", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"beatcrypto", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"beatcrypto", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"beatcrypto", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"beatcrypto", "getmasternodescores", &getmasternodescores, true, true, false},
        {"beatcrypto", "mnbudget", &mnbudget, true, true, false},
        {"beatcrypto", "preparebudget", &preparebudget, true, true, false},
        {"beatcrypto", "submitbudget", &submitbudget, true, true, false},
        {"beatcrypto", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"beatcrypto", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"beatcrypto", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"beatcrypto", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"beatcrypto", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"beatcrypto", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"beatcrypto", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"beatcrypto", "checkbudgets", &checkbudgets, true, true, false},
        {"beatcrypto", "mnsync", &mnsync, true, true, false},
        {"beatcrypto", "spork", &spork, true, true, false},
        {"beatcrypto", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"beatcrypto", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beatcryptod, or the -server option to beatcrypto-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> beatcrypto-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18899/\n";
}
