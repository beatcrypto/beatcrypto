...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BeatCrypto Core"),
     ...
     * override -datadir in the beatcrypto.conf file in the default data directory
     * (to be consistent with beatcryptod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
