Contributing to BeatCrypto Core
============================

The BeatCrypto Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BeatCrypto Core project, and is not to be
confused with overall BeatCrypto Network Protocol consensus changes.

Whether a pull request is merged into BeatCrypto Core rests with the project merge
...
Patches that change BeatCrypto consensus rules are considerably more involved than
...
Where a patch set proposes to change the BeatCrypto consensus, it must have been
...
The project leader is the release manager for each BeatCrypto Core release.
