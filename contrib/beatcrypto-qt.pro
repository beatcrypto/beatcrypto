...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/beatcrypto-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/beatcrypto-cli.cpp \
           src/beatcrypto-tx.cpp \
           src/beatcrypto.cpp \
           src/db.cpp \
           ...
           src/qt/beatcrypto.cpp \
           src/qt/beatcryptostrings.cpp \
...
RESOURCES += src/qt/beatcrypto.qrc src/qt/beatcrypto_locale.qrc

TRANSLATIONS += src/qt/locale/beatcrypto_bg.ts \
                src/qt/locale/beatcrypto_de.ts \
                src/qt/locale/beatcrypto_en.ts \
                src/qt/locale/beatcrypto_es.ts \
                src/qt/locale/beatcrypto_fi.ts \
                src/qt/locale/beatcrypto_fr.ts \
                src/qt/locale/beatcrypto_it.ts \
                src/qt/locale/beatcrypto_ja.ts \
                src/qt/locale/beatcrypto_pl.ts \
                src/qt/locale/beatcrypto_pt.ts \
                src/qt/locale/beatcrypto_ru.ts \
                src/qt/locale/beatcrypto_sk.ts \
                src/qt/locale/beatcrypto_sv.ts \
                src/qt/locale/beatcrypto_vi.ts \
                src/qt/locale/beatcrypto_zh_CN.ts \
                src/qt/locale/beatcrypto_zh_TW.ts
