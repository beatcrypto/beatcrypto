...
In order to support loading of multiple wallets in beatcrypto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beatcrypto.cpp.
...
Changes to beatcrypto.cpp
----------------------
beatcrypto.cpp is the entry point into beatcrypto-qt, and as such, will require some minor modifications to provide hooks for
